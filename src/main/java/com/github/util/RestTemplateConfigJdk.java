...
//@Configuration
public class RestTemplateConfigJdk {
	...
	public ClientHttpRequestFactory clientHttpRequestFactory() {
		...
		((SimpleClientHttpRequestFactory) clientHttpRequestFactory).setConnectTimeout(4 * 1000);
		((SimpleClientHttpRequestFactory) clientHttpRequestFactory).setReadTimeout(6 * 1000);
